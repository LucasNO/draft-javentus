...
import com.draft.javentus.dto.Rodada;
import com.draft.javentus.model.Confronto;
import com.draft.javentus.model.Fase;
...
//                System.out.println(c.getTime1().getNome() + " X " + c.getTime2().getNome() + " - " + c.getFase().getDescricao());
